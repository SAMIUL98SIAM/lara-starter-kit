...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div><div>{{ isset($page) ? 'Edit' : 'Create New' }} Page</div></div>
        </div>
        <div class="page-title-actions">
            <a href="{{route('app.pages.index')}}" type="button" class="btn-shadow mr-3 btn btn-primary"><i class="fas fa-backspace"></i> Back to list</a>
        </div>
    </div>
</div>
                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image" @isset($page) class="form-control @error('image') is-invalid @enderror" @endisset id="image">
                                ...
                                <div class="form-group">
                                    <img id="showImage" src="{{!empty($page->image)?url('/uploads/page_images/'.$page->image):url('/uploads/no_image.jpg')}}" height="150px" width="130px;" alt="Card image cap"/>
                                </div>
